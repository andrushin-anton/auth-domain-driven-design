...
interface RequestUserEmailPassword extends Request {
    body: {
        email: string,
        password: string,
    }
...
router.post('/auth/login', async (req: RequestUserEmailPassword, res: Response): Promise<void> => {
